...
go test ./...
go build -o bin/extract-go ./cmd/extract-go
./bin/extract-go run --project examples/conformance/http-handlefunc --source ./input --rule examples/conformance/http-handlefunc/rule.ser
```
